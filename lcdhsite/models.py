...
class Celula(models.Model):
    ...
    description = SanitizedProseEditorField(max_length=10000, blank=True,
                                            verbose_name="Descripción")  # max_length=10000, blank=True
...
class Profesion(models.Model):
    categoriaProfesion = models.ForeignKey(CategoriaProfesion, on_delete=models.SET_NULL, null=True,
                                           verbose_name="Categoría de la profesión")
...
class Compa(models.Model):
    ...
    picture = models.ImageField(upload_to='compas', blank=True, verbose_name="Foto del compa")
...
class Anuncio(models.Model):
    ...
    image = models.ImageField(upload_to='anuncios', blank=True, verbose_name="Imágen")
